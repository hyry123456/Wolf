...
TEXTURE2D(_SSSPyramid0);
SAMPLER(sampler_SSSPyramid0);
...
{
	uint index = roughness * 3.0;

	switch (index){
		case 0:
			return SAMPLE_TEXTURE2D(_SSSPyramid0, sampler_SSSPyramid0, screenUV).xyz;
		case 1:
			return SAMPLE_TEXTURE2D(_SSSPyramid1, sampler_SSSPyramid0, screenUV).xyz;
		case 2:
			return SAMPLE_TEXTURE2D(_SSSPyramid2, sampler_SSSPyramid0, screenUV).xyz;
		default:
			return SAMPLE_TEXTURE2D(_SSSPyramid3, sampler_SSSPyramid0, screenUV).xyz;
	}
}
